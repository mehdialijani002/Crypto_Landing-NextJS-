...
export default function Footer() {
  return (
    <MDBFooter bgColor="light" className={style.footer}>
        ...
        <MDBContainer className="text-center text-md-start mt-5">
          <MDBRow className="mt-3">
            ...
            <MDBCol md="2" lg="2" xl="2" className="mx-auto text-center mb-4">
              ...
              <p className="header-footer-right">بیت کوین </p>
              <p className="header-footer-right">درباره ما </p>
              <p className="header-footer-right">ارشیو </p>
              <p className="header-footer-right">تاریخچه</p>
            </MDBCol>
      ...
      >
        <div dir="rtl">
          <p className="mt-3">
            © کلیه حقوق این وبسایت برای ارز دیجیتال محفوظ است
          </p>
        </div>
      </div>
    </MDBFooter>
